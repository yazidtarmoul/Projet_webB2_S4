...
DDEESSCCRRIIPPTTIIOONN
       ...
       --ccffttuuvvSSUUXX nor ----ssoorrtt is specified.
       ...
       ----bblloocckk--ssiizzee=_S_I_Z_E
              with --ll, scale sizes by SIZE when printing them; e.g., '--block-size=M'; see SIZE format below

       --BB, ----iiggnnoorree--bbaacckkuuppss
              do not list implied entries ending with ~

       --cc     with --lltt: sort by, and show, ctime (time of last modification of file  status  information);  with  --ll:
       ...
       ----ffoorrmmaatt=_W_O_R_D
              across --xx, commas --mm, horizontal --xx, long --ll, single-column --11, verbose --ll, vertical --CC
       ...
       ----ggrroouupp--ddiirreeccttoorriieess--ffiirrsstt
              ...
              can be augmented with a ----ssoorrtt option, but any use of ----ssoorrtt=_n_o_n_e (--UU) disables grouping
       ...
       ----hhiiddee=_P_A_T_T_E_R_N
              do not list implied entries matching shell PATTERN (overridden by --aa or --AA)

       ----hhyyppeerrlliinnkk[=_W_H_E_N]
              hyperlink file names; WHEN can be 'always' (default if omitted), 'auto', or 'never'

       ----iinnddiiccaattoorr--ssttyyllee=_W_O_R_D
              append  indicator  with style WORD to entry names: none (default), slash (--pp), file-type (----ffiillee--ttyyppee),
              classify (--FF)
       ...
       --kk, ----kkiibbiibbyytteess
              default to 1024-byte blocks for disk usage; used only with --ss and per directory totals
       ...
       ----ssoorrtt=_W_O_R_D
              sort by WORD instead of name: none (--UU), size (--SS), time (--tt), version (--vv), extension (--XX)

       ----ttiimmee=_W_O_R_D
              change the default of using modification times; access time (--uu): atime, access, use; change time (--cc):
              ctime, status; birth time: birth, creation;

              with --ll, WORD determines which time to show; with ----ssoorrtt=_t_i_m_e, sort by WORD (newest first)

       ----ttiimmee--ssttyyllee=_T_I_M_E___S_T_Y_L_E
              time/date format with --ll; see TIME_STYLE below

       --tt     sort by time, newest first; see ----ttiimmee

       --TT, ----ttaabbssiizzee=_C_O_L_S
              assume tab stops at each COLS instead of 8

       --uu     with  --lltt:  sort by, and show, access time; with --ll: show access time and sort by name; otherwise: sort
       ...
       Using color to distinguish file types is disabled both by default and with ----ccoolloorr=_n_e_v_e_r.  With  ----ccoolloorr=_a_u_t_o,
